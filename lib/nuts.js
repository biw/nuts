...
function Nuts(opts) {
  ...
  this.router.get("/", this.onDownload.bind(this))
  this.router.get(
  ...
  this.router.get("/download/:tag/:filename", this.onDownload.bind(this))
  this.router.get("/download/:platform?", this.onDownload.bind(this))
  ...
  this.router.get("/update", this.onUpdateRedirect.bind(this))
  this.router.get("/update/:platform/:version", this.onUpdate.bind(this))
  this.router.get(
  ...
  this.router.get("/notes/:version?", this.onServeNotes.bind(this))

  // Bind API
  this.router.use("/api", this.onAPIAccessControl.bind(this))
